...
public class CheckDouble {
    ...
    public boolean checkIfExist(int[] arr) {
        ...
        Arrays.sort(arr);//{-950 -933 -918 -909 -892 -880 -857 -852 -815 -814 -803 -797 -741 -738 -691 -637 -592 -584 -488 ***-485*** -453 -448 -360 -334 **-242** -191 -132 -124 -93 -87 -40 26 50 74 88 98 102 250 304 356 360 449 457 461 476 508 522 540 563 639 665 745 750 802 806 833 840 868 881 883 991 999}
        for(int i = 19; i < arr.length -1;i++){
            int m = arr[i] * 2;
            int n = arr[i]/2;
